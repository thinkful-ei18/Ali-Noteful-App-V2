...
ALTER SEQUENCE note_id_seq RESTART WITH 1000;
ALTER TABLE note ADD COLUMN folder_id int REFERENCES folders ON DELETE SET NULL; -- or RESTRICT
...
INSERT INTO note (title, content, folder_id) VALUES 
  (
